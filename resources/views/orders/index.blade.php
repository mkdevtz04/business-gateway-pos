        ...
        <div class="overflow-x-auto">
            <table class="min-w-full bg-white">
                <thead class="bg-gray-200">
                    <tr>
                        <th class="w-1/4 py-3 px-4 uppercase font-semibold text-sm text-left">Order ID</th>
                        <th class="w-1/4 py-3 px-4 uppercase font-semibold text-sm text-left">Customer</th>
                        <th class="py-3 px-4 uppercase font-semibold text-sm text-left">Total Amount</th>
